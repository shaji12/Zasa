...
public class Product {
    ...
    public void selectStockCategory() {
    	...
    	WebElement field = wait.until(ExpectedConditions.elementToBeClickable(stockCategoryField));

    	field.click();

    	stockCategoryOption.click();

    	//wait.until(ExpectedConditions.elementToBeClickable(stockCategoryOption)).click();
    ...
    public void selectGrade() {
    	...
    	wait.until(ExpectedConditions.elementToBeClickable(gradeField)).click();

    	wait.until(ExpectedConditions.elementToBeClickable(gradeOption)).click();
